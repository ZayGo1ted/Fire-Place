    ...
    <section id="contact" className="py-32 bg-[#0a0a0a] relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <span className="text-[#ff4d00] font-bold uppercase tracking-[0.5em] mb-4 block text-[10px]">{t.contact.label}</span>
          <h2 className="text-5xl md:text-7xl font-serif font-bold mb-8 text-white tracking-tighter italic">{t.contact.title}</h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-xl leading-relaxed font-light">{t.contact.desc}</p>
        </div>
