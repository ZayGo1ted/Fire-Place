    ...
    <section id="contact" className="py-32 bg-[#0a0a0a] relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl md:text-7xl font-serif font-bold mb-8 text-white tracking-tighter italic">{t.title}</h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-xl leading-relaxed font-light">{t.desc}</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="liquid-glass liquid-glass-hover p-12 rounded-[2.5rem] transition-all duration-700 group flex flex-col items-center text-center">
            ...
            <h4 className="text-[10px] font-bold mb-4 uppercase tracking-[0.4em] text-white/30">{t.phone}</h4>
          ...
          <div className="liquid-glass liquid-glass-hover p-12 rounded-[2.5rem] transition-all duration-700 group flex flex-col items-center text-center">
            ...
            <h4 className="text-[10px] font-bold mb-4 uppercase tracking-[0.4em] text-white/30">WhatsApp</h4>
          ...
          <div className="liquid-glass liquid-glass-hover p-12 rounded-[2.5rem] transition-all duration-700 group flex flex-col items-center text-center">
            ...
            <h4 className="text-[10px] font-bold mb-4 uppercase tracking-[0.4em] text-white/30">{t.open}</h4>
