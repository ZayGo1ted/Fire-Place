  ...
  return (
    <section id="about" className="min-h-screen flex items-center py-24 bg-[#080808] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 items-center max-w-[1400px] mx-auto">
          ...
          <div className="lg:col-span-6 order-2 lg:order-1">
            ...
            <h2 className="text-4xl md:text-6xl lg:text-8xl font-serif font-bold mb-10 leading-[0.9] text-white tracking-tighter">
              {t.title} <br /> <span className="text-[#ff4d00] italic">Riverside</span>
            </h2>
            <p className="text-gray-400 text-base md:text-xl leading-relaxed font-light mb-12 max-w-lg">
              {t.desc}
            </p>
            ...
            <div className="grid grid-cols-2 gap-12 pt-10 border-t border-white/5">
              ...
              <div className="flex flex-col gap-2">
                <span className="text-3xl font-serif font-bold text-white tracking-tighter italic">Sebou</span>
